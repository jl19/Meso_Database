...
#### backend
o	MySQL database
o	REST API written in Java Spring
o	Redis cache for storing frequently used queries (optional)
...
o	REST API written in Java Spring enabling retrieval and writing to the database
o	MongoDB database
